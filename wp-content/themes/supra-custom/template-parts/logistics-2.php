<?php
/**
 * Template part for logistics page section 2
 *
...
$section_info = get_section_info( 'logistics-section', '2', get_the_ID() );
$overviews    = isset( $section_info['history'] ) && is_array( $section_info['history'] ) ? $section_info['history'] : array();
?>
<div id="logistics-section-2" class="logistics-section">
