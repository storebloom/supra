<?php
/**
 * Template part for distribution page section 2
 *
...
$section_info = get_section_info( 'distribution-section', '2', get_the_ID() );
$overviews    = isset( $section_info['history'] ) && is_array( $section_info['history'] ) ? $section_info['history'] : array();
?>
<div id="distribution-section-2" class="distribution-section">
